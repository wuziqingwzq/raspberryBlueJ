...
public class BallDemo   
{
    ...
    public BallDemo()
    {
        myCanvas = new Canvas("Îâ×ÓÇåµÄDemo", 600, 500);
    ...
    public void bounce()
    {
        ...
        ball.draw();
        BouncingBall ball2 = new BouncingBall(400, 300, 20, Color.red, ground, myCanvas);
        ball2.draw();
    ...
    public void drawtest(){
        Canvas testcanvas = new Canvas("my canvas",200,200,Color.green);
        testcanvas.setVisible(true);
        testcanvas.drawLine(10,10,30,10);
        testcanvas.drawLine(30,10,30,30);
        testcanvas.drawLine(30,30,10,30);
        testcanvas.drawLine(10,30,10,10);
        testcanvas.draw(new Rectangle(10,50,20,20));
    }
    
    public void drawFrame(){
       myCanvas.draw(new Rectangle(20,20,myCanvas.getSize().width-40,myCanvas.getSize().height-40));
    }
}
