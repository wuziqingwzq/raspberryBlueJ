...
public class OneHourTests
{
    ...
    public void makeThreeAppointments()
    {
        ...
        Appointment fourth = new Appointment("ok", 1);
        Appointment fifth = new Appointment("nice", 1);
        
        // Make each appointment at a different time.
        day.makeAppointment(9, first);
        day.makeAppointment(10, fourth);
        day.makeAppointment(11, fifth);
    ...
    public void testDoubleHours(){
        ...
        Appointment fourth = new Appointment("ok", 2);
        Appointment fifth = new Appointment("nice", 2);
        
        // Make each appointment at a different time.
        day.makeAppointment(9, first);
        day.makeAppointment(11, fourth);
        day.makeAppointment(13, fifth);
        day.makeAppointment(15, second);
        day.makeAppointment(17, third);
